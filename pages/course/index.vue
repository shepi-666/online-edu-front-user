        ...
        <section class="c-s-dl">
          <dl>
            ...
            <dd class="c-s-dl-li">
              <ul class="clearfix">
                <li>
                  <a title="全部" href="#" @click="initCoursePage()">全部</a>
                </li>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // 查询所有的分类，用于联动
      initSubject() {
        courseApi.getSubjects().then(response => {
      ...
      // 4 点击某一个一级分类，查询对应二级分类
      searchOne(id, index) {
        // 将传进来的index值赋值给OneIndex,为了样式可以生效
        this.oneIndex = index
        this.twoIndex = -1
        ...
        // 拿着点击的id和所有的一级id做一个比较，如果id相同，就从
        // 其对应的一级分类，拿出他的二级分类
